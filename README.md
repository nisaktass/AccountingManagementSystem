# Bankacılık ve İşlem Yönetim Sistemi (Java Swing)
...
* **Yönetici Paneli (`Admin`):** Sistemdeki kullanıcıları, hesap hareketlerini ve genel sistem durumunu izleme yetkisi.
...
* **Proje Yönetimi:** Maven (Dependency Management)
